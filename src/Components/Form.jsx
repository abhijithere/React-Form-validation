...
const Form = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen  p-4">
      <form className="w-full max-w-lg bg-[#1C1C1C]   p-8 shadow-xl border-[1px] border-[#282828] rounded-lg" onSubmit={handleSubmit}>
        <h2 className="text-3xl font-bold mb-6  text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-cyan-500 ">Registration Form</h2>
        {[
        ...
        <div className="mb-4">
          <label className="block text-gray-300 text-sm font-bold mb-2" htmlFor="region">
            Region
          </label>
          <RegionDropdown
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            ...
            <button
              type="button"
              className="absolute inset-y-0 right-0 px-3 py-2 text-slate-300"
        ...
        <div className="flex items-center justify-between">
          <button
            ...
            className="text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-cyan-500 border-yellow-700 border-[2px] text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline disabled:opacity-50"
          >
            Submit
          </button>
        </div>
